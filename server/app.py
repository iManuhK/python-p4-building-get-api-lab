...
def baked_goods_by_price():
    baked_by_prices = [baked_good.to_dict() for baked_good in BakedGood.query.order_by(BakedGood.price.desc()).all()]
    response = make_response(jsonify(baked_by_prices), 200)
    return response
